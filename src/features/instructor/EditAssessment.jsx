...
// Parent (AssessmentManagement) passes key={courseId}, so this component
// remounts on course change — no manual state reset needed here.
export default function EditPanel({ courseId, courses, onSwitchCourse }) {
        ...
        <div className="col-span-12 lg:col-span-6">
          <section className="h-full rounded-xl bg-surface-container-lowest p-8 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)]">
            ...
            {isDetailLoading && selectedAssessmentId && (
              <p className="mt-4 px-1 text-xs text-outline">Loading details…</p>
            )}
          </section>
        </div>
            ...
            <QuestionEditor
              ...
              onQuestionAdded={(newPoolSize) => {
                ...
                if (
                  ...
                  toast.success(`Question count updated to ${newPoolSize}.`);
                }
              }}
            />
          </div>
                ...
                <p className="text-[11px] text-on-surface-variant">
                  {!selectedAssessmentId
                    ...
                    : isPublished
                      ...
                      : "Edit any details, questions, or rubric. Use Save to keep working as a draft, or Publish to release this assessment to students. Copy duplicates it; Delete removes it."}
                </p>
              </div>
            </div>
