        ...
        <div className="mx-auto max-w-5xl px-12 py-16">
          ...
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-12 space-y-8 lg:col-span-7">
              ...
              <div className="flex items-center justify-between rounded-xl border border-primary/10 bg-primary/5 p-8">
                ...
                <button className="rounded-xl bg-primary px-8 py-4 font-bold tracking-tight text-on-primary shadow-lg shadow-primary/20 transition-all hover:bg-primary-dim active:scale-[0.98]">
                  Update Now
                </button>
              </div>
            </div>
            ...
            <div className="col-span-12 lg:col-span-5">
              <section className="flex h-full flex-col items-center justify-center rounded-xl border-2 border-dashed border-outline-variant/30 bg-surface-container-low p-8 text-center">
                <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-surface-container-lowest shadow-sm">
                  <span
                ...
                <div className="w-full space-y-4">
                  <div className="flex items-center gap-3 rounded-xl border border-outline-variant/10 bg-surface-container-lowest p-4 text-left shadow-sm">
                    <div className="flex h-10 w-10 items-center justify-center rounded bg-error/10 text-error">
                      <span
                        className="material-symbols-outlined"
                  ...
                  <label className="block cursor-pointer">
                    ...
                    <div className="w-full rounded-xl border border-outline-variant/20 bg-white py-4 text-center text-sm font-bold text-primary transition-all hover:bg-primary/5">
                      Browse Other Files
                    </div>
                  </label>
                </div>
          ...
          <div className="mt-12 flex items-center gap-6 rounded-xl bg-surface-container p-6">
            <img
            ...
            <button className="rounded-lg px-4 py-2 text-sm font-bold text-primary transition-all hover:bg-white">
              View Guide
            </button>
          </div>
        </div>
